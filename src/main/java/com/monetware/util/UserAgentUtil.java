...
/** 
 *@author  venbillyu 
 *@date 创建时间：2016年12月14日 上午9:19:20 
 *@describle 获取请求头
 */
public class UserAgentUtil {
    ...
    //初始化
    static {   
		webUserAgentMap=new HashMap<String, String>();
		webUserAgentList=new ArrayList<String>();
    ...
    public static String getOneRandom(){
    	return webUserAgentList.get(
    	(int) Math.round(Math.random()*(webUserAgentList.size()-1))); 
