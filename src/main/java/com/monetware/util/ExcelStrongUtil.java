...
/**
 *
 * http://blog.csdn.net/xiaoxian8023/article/details/40597835
 * 封装poi操作excel工具类
 * Created by venbill on 2017/4/5.
 */
public class ExcelStrongUtil {
...
/*    public static void main(String[] args) {
        ExcelStrongUtil eu = new ExcelStrongUtil();
    ...
    public ExcelStrongUtil(){

    }

    public ExcelStrongUtil(String excelPath){
     ...
     * @return
     */
    public ExcelStrongUtil RestoreSettings(){
        ExcelStrongUtil instance = new  ExcelStrongUtil(this.excelPath);
        return instance;
    }
