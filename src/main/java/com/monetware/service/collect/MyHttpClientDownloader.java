...
public class MyHttpClientDownloader extends AbstractDownloader {
    ...
    public MyHttpClientDownloader(long projectId,CollectLogService logService){
        super();
    ...
    public Page download(Request request, Task task) {
        ...
        logService.info(projectId,"downloading page " + request.getUrl());
        ...
        try {
            ...
            if (statusAccept(acceptStatCode, statusCode)) {
                ...
                logService.warn(projectId,"get page "+request.getUrl()+" error, status code "+statusCode);
                return null;
            }
        } catch (IOException e) {
            logger.warn("download page {} error", request.getUrl(), e);
            logService.error(projectId,"download page "+request.getUrl()+" error "+ e);
