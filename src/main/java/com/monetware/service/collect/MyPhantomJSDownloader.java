...
public class MyPhantomJSDownloader extends AbstractDownloader {
     ...
     */
    public MyPhantomJSDownloader(String phantomJsCommand) {
        this.initPhantomjsCrawlPath();
        MyPhantomJSDownloader.phantomJsCommand = phantomJsCommand;
    }
     ...
     */
    public MyPhantomJSDownloader(String phantomJsCommand, String crawlJsPath) {
        MyPhantomJSDownloader.phantomJsCommand = phantomJsCommand;
        MyPhantomJSDownloader.crawlJsPath = crawlJsPath;
    }

    private void initPhantomjsCrawlPath() {
        MyPhantomJSDownloader.crawlJsPath = new File(this.getClass().getResource("/").getPath()).getPath() + System.getProperty("file.separator") + "crawl.js ";
    }
    ...
    public MyPhantomJSDownloader setRetryNum(int retryNum) {
